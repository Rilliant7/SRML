...
class tieredImageNet(Dataset):
    ...
    def __init__(self, setname, args=None, return_path=False):
        TRAIN_PATH = osp.join(args.data_dir, 'tieredimagenet/train')
        VAL_PATH = osp.join(args.data_dir, 'tieredimagenet/val')
        TEST_PATH = osp.join(args.data_dir, 'tieredimagenet/test')
        if setname == 'train':
            THE_PATH = TRAIN_PATH
        elif setname == 'test':
            THE_PATH = TEST_PATH
